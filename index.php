...
if (isset($_POST['btn-login'])) {
	...
	$query = $DBcon->query("SELECT * FROM users WHERE u_email='$username' OR u_cont='$username'");
	$row=$query->fetch_array();
	$count = $query->num_rows; // if email/password are correct returns must be 1 row
	
	if (password_verify($password, $row['u_pass']) && $count==1) {
         ...
         <div class="container-fluid pl-0 pr-0">
            ...
            <form class="form" method="POST">
                        ...
                        <div class="mt-4">
                           <div class="row">
                              <div class="col-12">
                                 <button type="submit" name="btn-login" class="btn btn-outline-primary btn-block btn-lg">Sign In</button>
                              </div>
                           </div>
                        </div>
                     </form>
